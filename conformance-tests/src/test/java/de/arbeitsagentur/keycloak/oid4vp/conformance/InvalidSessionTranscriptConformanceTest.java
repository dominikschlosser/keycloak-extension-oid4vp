...
// Verifier rejects a presentation with an invalid mdoc session transcript
@KeycloakIntegrationTest(config = AbstractVerifierConformanceTest.VerifierServerConfig.class)
class InvalidSessionTranscriptConformanceTest extends AbstractVerifierConformanceTest {

    @Override
    protected Stream<ConformanceModuleVariant> moduleVariants() {
        return negativeVerifierModuleVariants("oid4vp-1final-verifier-invalid-session-transcript");
    }
}
