...
// Verifier rejects a presentation with an invalid key binding JWT nonce
@KeycloakIntegrationTest(config = AbstractVerifierConformanceTest.VerifierServerConfig.class)
class InvalidKbJwtNonceConformanceTest extends AbstractVerifierConformanceTest {

    @Override
    protected Stream<ConformanceModuleVariant> moduleVariants() {
        return negativeVerifierModuleVariants("oid4vp-1final-verifier-invalid-kb-jwt-nonce");
    }
}
