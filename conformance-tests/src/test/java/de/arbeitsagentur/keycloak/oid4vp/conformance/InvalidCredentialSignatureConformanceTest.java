...
// Verifier rejects a presentation with an invalid credential signature
@KeycloakIntegrationTest(config = AbstractVerifierConformanceTest.VerifierServerConfig.class)
class InvalidCredentialSignatureConformanceTest extends AbstractVerifierConformanceTest {

    @Override
    protected Stream<ConformanceModuleVariant> moduleVariants() {
        return negativeVerifierModuleVariants("oid4vp-1final-verifier-invalid-credential-signature");
    }
}
